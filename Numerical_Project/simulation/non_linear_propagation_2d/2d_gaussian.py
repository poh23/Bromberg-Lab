...
def non_linear_propagation_of_2d_gaussian():
    ...
    L = 1.25  # max distance because then the beam is too wide and there are edge effects
    N = 2 ** 9
    ...
    kerr_coefficient = 1e-6 # when kerr_coefficient is larger than 1e-3 there isn't energy conservation
