...
def propagate_sech():
    ...
    square_width = 3e-3
    sigma = 50e-6
    A0 = np.sqrt(2 * split_step.free_space_impedance * split_step.refractive_index / ((split_step.k * sigma) ** 2 * kerr_coefficient)) # Refractive index factor is kind of wierd
